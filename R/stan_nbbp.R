...
#'
#' We let r_eff ~ Gamma(shape = a_r_eff, rate = b_r_eff)
#' with the default being Lognormal(shape = rate = 2.183089).
#' The default has a mean R of 1, and 66.7% prior CI of spanning from 1/2 to 2.
#'
...
#' see details.
#' @param a_r_eff shape parameter of Gamma prior on r_eff.
#' @param b_r_eff rate parameter of Gamma prior on r_eff.

...
\begin{equation}
\text{Pr}(c \mid R, k, \mathcal{E}) = \frac{\text{Pr}(c, \mathcal{E} \mid R, k)}{\text{Pr}(\mathcal{E} \mid R, k)}  = \frac{\text{Pr}(c \mid R, k)}{\text{Pr}(\mathcal{E} \mid R, k)}.
\end{equation}
...
$$
\begin{aligned}
p \epsilon &= p \sum_{u = u_m + 1}^{\infty} \mathrm{Pr}(c \mid u, p) \mathrm{Pr}(u \mid R, k)\\
